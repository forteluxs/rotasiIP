...
func Options() *common.Options {
	opt := &common.Options{Stats: common.NewProxyStats()}
	...
	flag.StringVar(&opt.UIAddress, "ui", "", "")

	flag.DurationVar(&opt.Delay, "delay", 0, "")
	flag.Float64Var(&opt.RateLimit, "rate-limit", 0, "")
	flag.StringVar(&opt.RetryStatusStr, "retry-on-status", "", "")
	flag.StringVar(&opt.ProxyCCStr, "proxy-cc", "", "")
